...
namespace EFDemo.Infrastructure.Repositories
{
    ...
    public class CustomerRepository : Repository<Customer>, ICustomerRepository
    {
        ...
        /// 
        /// ERROR EXPLANATION: The original implementation tried to use BaseSpecification<Customer>()
        /// which is abstract and can't be instantiated directly.
        /// 
        /// FIX EXPLANATION: We now use the AllCustomersSpecification for counting all customers,
        /// or we can count directly from the repository. This is cleaner and more explicit.
        /// </summary>
        public async Task<int> GetCustomerCountAsync(bool activeOnly = true)
        {
            ...
            {
                // LEARNING NOTE: For counting all customers, we can use the AllCustomersSpecification
                // or count directly from the DbSet. Using a specification keeps it consistent
                // with the rest of the architecture.
                var spec = new AllCustomersSpecification();
                return await CountAsync(spec);
            }
        }
